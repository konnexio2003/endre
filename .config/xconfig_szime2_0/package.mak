...
override PKGDIR = xconfig_szime2_0
...
/opt/ti/xdctools_3_25_03_72/packages/ti/targets/arm/elf/IArm.xs:
package.mak: /opt/ti/xdctools_3_25_03_72/packages/ti/targets/arm/elf/IArm.xs
/opt/ti/xdctools_3_25_03_72/packages/ti/targets/arm/elf/package.xs:
package.mak: /opt/ti/xdctools_3_25_03_72/packages/ti/targets/arm/elf/package.xs
...
ti.targets.arm.elf.packageBase ?= /opt/ti/xdctools_3_25_03_72/packages/ti/targets/arm/elf/
...
package/%.xdc.inc package/%_xconfig_szime2_0.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_szime2_0" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,em4f .dlls: szime2.0.pem4f

-include package/cfg/szime2.0_pem4f.mak
-include package/cfg/szime2.0_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/szime2.0_pem4f.dep
endif
szime2.0.pem4f: package/cfg/szime2.0_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
szime2.0.pem4f package/cfg/szime2.0_pem4f.c: .libraries,em4f
endif

package/cfg/szime2.0_pem4f.c package/cfg/szime2.0_pem4f.h package/cfg/szime2.0_pem4f.xdl: override _PROG_NAME := szime2.0.xem4f
package/cfg/szime2.0_pem4f.c: package/cfg/szime2.0_pem4f.cfg

clean:: clean,em4f
	-$(RM) package/cfg/szime2.0_pem4f.cfg
	-$(RM) package/cfg/szime2.0_pem4f.dep
	-$(RM) package/cfg/szime2.0_pem4f.c
	-$(RM) package/cfg/szime2.0_pem4f.xdc.inc

clean,em4f::
	-$(RM) szime2.0.pem4f
.executables,em4f .executables: szime2.0.xem4f

szime2.0.xem4f: |szime2.0.pem4f

-include package/cfg/szime2.0.xem4f.mak
szime2.0.xem4f: package/cfg/szime2.0_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armlnk -w -q -u _c_int00 -fs $(XDCCFGDIR)$(dir $@)  -q -o $@ package/cfg/szime2.0_pem4f.oem4f   package/cfg/szime2.0_pem4f.xdl --silicon_version=7M4 --strict_compatibility=on -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
szime2.0.xem4f: export C_DIR=
szime2.0.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/:$(PATH)

szime2.0.test test,em4f test: szime2.0.xem4f.test

szime2.0.xem4f.test:: szime2.0.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 szime2.0.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.szime2.0.xem4f, ) 
endif

clean,em4f::
	-$(RM) .tmp,szime2.0.xem4f,0,*
...
clean,em4f::
	-$(RM) szime2.0.xem4f
clean:: 
	-$(RM) package/cfg/szime2.0_pem4f.pjt
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
szime2.0_pem4f.oem4f,copy : package/cfg/szime2.0_pem4f.oem4f
szime2.0_pem4f.sem4f,copy : package/cfg/szime2.0_pem4f.sem4f

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg .interfaces $(XDCROOT)/packages/xdc/cfg/Main.xs
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_szime2_0
xconfig_szime2_0.tar: package/package.bld.xml
xconfig_szime2_0.tar: package/build.cfg
xconfig_szime2_0.tar: package/package.xdc.inc
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_szime2_0.tar.dep
endif
package/rel/xconfig_szime2_0/xconfig_szime2_0/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_szime2_0.tar: package/rel/xconfig_szime2_0.xdc.inc package/rel/xconfig_szime2_0/xconfig_szime2_0/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_szime2_0.xdc.inc,package/rel/xconfig_szime2_0.tar.dep)


release release,xconfig_szime2_0: all xconfig_szime2_0.tar
clean:: .clean
	-$(RM) xconfig_szime2_0.tar
	-$(RM) package/rel/xconfig_szime2_0.xdc.inc
	-$(RM) package/rel/xconfig_szime2_0.tar.dep
...
include custom.mak
clean:: 
	-$(RM) package/xconfig_szime2_0.pjt
